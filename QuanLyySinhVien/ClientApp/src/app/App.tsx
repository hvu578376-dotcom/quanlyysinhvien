...
export default function App() {
    ...
    // Nếu chưa đăng nhập thì trả về màn hình Login (bên ngoài)
    if (!authed) {
...
function HomeDashboard({ onNavigate }: { onNavigate: (page: PageKey) => void }) {
    return (
        <div>
            <div style={dashboardGrid}>
                <div style={dashboardCard}>
                    ...
                    <div style={cardDesc}>Danh sach cac module quan ly</div>
                </div>
            </div>
            ...
            <div style={quickActionWrap}>
                ...
                <div style={quickGrid}>
                    ...
                    <button
                        style={quickButton}
                        onClick={() => onNavigate("phanCongGiangDay")}
                    >
